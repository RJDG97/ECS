namespace xecs::archetype
{
    ...
    instance::instance( xecs::game_mgr::instance& GameMgr ) noexcept
    : m_GameMgr{ GameMgr }
    {}
    ...
    void instance::DestroyEntity( xecs::component::entity& Entity ) noexcept
    {
