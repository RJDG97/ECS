...
//
//        inline 
//        xecs::component::entity AllocNewEntity
//        (   
//            int                        PoolIndex, 
...
//
//        inline 
//        void DeleteEntity( xecs::component::entity& Entity ) noexcept;
//
//        //---------------------------------------------------------------------------
//
//        inline void SystemDeleteEntity
//        (   
//            xecs::component::entity  DeletedEntity, 
...
//        //---------------------------------------------------------------------------
//
//        template < typename T_FUNCTION = xecs::tools::empty_lambda> 
...
//        void Foreach 
//        ( 
//            const std::vector<xecs::archetype::instance*>& List, 
//            T_FUNCTION&& Function 
//        ) const noexcept;
//
//        //---------------------------------------------------------------------------
